...
class TeacherAttendanceClassesView
    extends GetView<TeacherAttendanceController> {
  const TeacherAttendanceClassesView({super.key});
            ...
            return Card(
              ...
              child: ListTile(
                leading: CircleAvatar(
                  ...
                  child: const Icon(Icons.class_, color: AppColors.accentLime),
                ),
                title: Text(
                  cls.classNumber,
